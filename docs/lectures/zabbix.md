...
![PILT: Discovery seadistamise ekraanivaade](../materials/lectures/Zabbix/media/z-discovery-rules.png)
---

## Automaatse avastamise ja tegevuste seadistamine (2)
Tegevuste seadistamine

![PILT: Actions seadistamise ekraanivaade](../materials/lectures/Zabbix/media/z-actions.png)
---

## Automaatse avastamise ja tegevuste seadistamine (3)
Tegevuste seadistamine

![PILT: Tegevuste tingimuste ja operatsioonide seadistamine](../materials/lectures/Zabbix/media/z-actions2.png)
...
![PILT: Hosts seadistamise ekraanivaade](../materials/lectures/Zabbix/media/z-hosts.png)
...
![PILT: Items seadistamise ekraanivaade](../materials/lectures/Zabbix/media/z-items.png)
...
![PILT: Triggers seadistamise ekraanivaade](../materials/lectures/Zabbix/media/z-triggers.png)
...
**Lihtsad graafikud**
![PILT: Zabbix'i lihtsa graafiku kuvatõmmis, mis näitab Apache mälu kasutust](../materials/lectures/Zabbix/media/z-graf1.png)
Teenivad andmeelemendiga kogutud andmete visualiseerimiseks

**Kasutaja graafikud**
![PILT: Zabbix'i kasutaja graafiku loomise vaade koos ringdiagrammiga](../materials/lectures/Zabbix/media/z-graf2.png)
Pakuvad individuaalse seadistamise võimalust

**Situatsioonilised graafikud**
![PILT: Zabbix'i situatsiooniliste graafikute kuvatõmmis ja võrdlevad graafikud](../materials/lectures/Zabbix/media/z-graf3.png)
Graafikud mitme andmeelemendi võrdlemiseks "lennult"

## Võrgukaardid

![PILT: Zabbix'i võrgukaartide vaade, mis näitab serverite ja agentide ühendusi](../materials/lectures/Zabbix/media/z-network-map.png)
...
![Olulisuse tasemed](../materials/lectures/Zabbix/media/z-olulise1.png)
...
![Olulisuse tasemed](../materials/lectures/Zabbix/media/z-olulise2.png)
...
![Eskalatsioon](../materials/lectures/Zabbix/media/z-escalation.png)
...
![E-post](../materials/lectures/Zabbix/media/z-alert1.png)
![E-post](../materials/lectures/Zabbix/media/z-alert2.png)
...
![Telegram](../materials/lectures/Zabbix/media/z-alert3.png)
![Telegram](../materials/lectures/Zabbix/media/z-alert4.png)
...
![Teised sõnumirakendused](../materials/lectures/Zabbix/media/z-alert5.png)
![Teised sõnumirakendused](../materials/lectures/Zabbix/media/z-alert6.png)
![Teised sõnumirakendused](../materials/lectures/Zabbix/media/z-alert7.png)
![Teised sõnumirakendused](../materials/lectures/Zabbix/media/z-alert8.png)
...
![SMS läbi lüüsi](../materials/lectures/Zabbix/media/z-alert9.png)
...
![SMS läbi GSM-modemi](../materials/lectures/Zabbix/media/z-alert10.png)
...
![Push-teavitused](../materials/lectures/Zabbix/media/z-alert11.png)
...
![Teenindustoe piletid](../materials/lectures/Zabbix/media/z-alert12.png)
...
![Kõne sõnumiga](../materials/lectures/Zabbix/media/z-alert13.png)
...
![Teavituste loogika](../materials/lectures/Zabbix/media/z-not1.png)
...
![Lahendatud probleem](../materials/lectures/Zabbix/media/z-not2.png)
...
![PILT: MIB kirjeldus ja OID puu näide](../materials/lectures/Zabbix/media/z-mib.png)
...
![PILT: Näide Zabbix Discovery konfiguratsioonist](../materials/lectures/Zabbix/media/z-disc1.png)
...
![PILT: Näide SNMP Discovery konfiguratsioonist](../materials/lectures/Zabbix/media/z-disc2.png)
