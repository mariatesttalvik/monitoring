...
- [Prometheus: Monitoring Made Simple](#prometheus-monitoring-made-simple)
  - [1. Observability Refresher](#1-observability-refresher)
    - [What is Observability?](#what-is-observability)
    - [Monitoring Approaches](#monitoring-approaches)
      - [Black Box vs. White Box Monitoring](#black-box-vs-white-box-monitoring)
      - [Black Box Monitoring](#black-box-monitoring)
      - [White Box Monitoring](#white-box-monitoring)
    - [Study Case with Prometheus: Website Slowdown Investigation](#study-case-with-prometheus-website-slowdown-investigation)
  - [2. Prometheus: History and Overview](#2-prometheus-history-and-overview)
    - [The History of Prometheus](#the-history-of-prometheus)
    - [Key Differentiators of Prometheus](#key-differentiators-of-prometheus)
    - [What is Prometheus?](#what-is-prometheus)
  - [3. Prometheus Architecture and Components](#3-prometheus-architecture-and-components)
    - [Core Components](#core-components)
    - [How Prometheus Works: The Pull Model](#how-prometheus-works-the-pull-model)
    - [Advantages of the Pull Model](#advantages-of-the-pull-model)
    - [The Pushgateway for Short-lived Jobs](#the-pushgateway-for-short-lived-jobs)
  - [4. Prometheus Versioning and Compatibility](#4-prometheus-versioning-and-compatibility)
    - [Version Compatibility](#version-compatibility)
  - [5. Prometheus Data Model](#5-prometheus-data-model)
    ...
    - [Metric Types](#metric-types)
      ...
      - [Histogram](#histogram)
      - [Summary](#summary)
    - [Comparing Metric Types](#comparing-metric-types)
  - [6. Security and Authentication in Prometheus](#6-security-and-authentication-in-prometheus)
    - [The Authentication Challenge](#the-authentication-challenge)
    - [Security Best Practices](#security-best-practices)
      - [1. Network-level Security](#1-network-level-security)
      - [2. Reverse Proxy Authentication](#2-reverse-proxy-authentication)
      - [3. Using a Third-party Authentication Proxy](#3-using-a-third-party-authentication-proxy)
      - [4. API Access Security](#4-api-access-security)
    - [Security for AlertManager](#security-for-alertmanager)
    - [Handling Metrics with Sensitive Data](#handling-metrics-with-sensitive-data)
  - [7. Data Collection with Exporters](#7-data-collection-with-exporters)
    - [What are Exporters?](#what-are-exporters)
    - [Common Exporters](#common-exporters)
    - [Node Exporter in Detail](#node-exporter-in-detail)
  - [8. Introduction to PromQL](#8-introduction-to-promql)
    - [Basic Queries](#basic-queries)
    - [Label Matching Operators](#label-matching-operators)
    - [Working with Counters](#working-with-counters)
    - [Aggregation Operators](#aggregation-operators)
    - [Practical Examples](#practical-examples)
      - [CPU Usage Percentage](#cpu-usage-percentage)
      - [Memory Usage Percentage](#memory-usage-percentage)
      - [Disk Space Usage Percentage](#disk-space-usage-percentage)
      - [Top 5 Processes by CPU Usage](#top-5-processes-by-cpu-usage)
  - [9. Prometheus Storage and Retention](#9-prometheus-storage-and-retention)
    - [Storage Architecture](#storage-architecture)
    - [Data Retention](#data-retention)
    - [Storage Best Practices](#storage-best-practices)
    - [Dealing with Storage Limitations](#dealing-with-storage-limitations)
  - [10. Alerting with Prometheus](#10-alerting-with-prometheus)
    - [Alert Rules](#alert-rules)
    - [AlertManager](#alertmanager)
    - [Alert Notification Channels](#alert-notification-channels)
  - [11. Prometheus for Beginners: Getting Started](#11-prometheus-for-beginners-getting-started)
    - [1. Start Small](#1-start-small)
    - [2. Expand Your Monitoring](#2-expand-your-monitoring)
    - [3. Common Beginner Mistakes to Avoid](#3-common-beginner-mistakes-to-avoid)
    - [4. Essential Queries Every Beginner Should Know](#4-essential-queries-every-beginner-should-know)
  - [12. Best Practices](#12-best-practices)
    - [Naming Conventions](#naming-conventions)
    - [Label Best Practices](#label-best-practices)
    - [Instrumentation Tips](#instrumentation-tips)
    - [Performance Considerations](#performance-considerations)
  - [13. Prometheus in Production](#13-prometheus-in-production)
    - [High Availability Strategies](#high-availability-strategies)
    - [Prometheus Scalability Limits](#prometheus-scalability-limits)
