...
- [Häirete seadistamine](#häirete-seadistamine)
  - [Teemad](#teemad-1)
  - [Põhilised lähenemisviisid teavituste saatmiseks](#põhilised-lähenemisviisid-teavituste-saatmiseks)
    - [Parameetrite valik](#parameetrite-valik)
    - [Käivitamislävi](#käivitamislävi)
    - [Kas teavitused sisse lülitada või mitte?](#kas-teavitused-sisse-lülitada-või-mitte)
    - [Olulisuse tase](#olulisuse-tase)
    - [Eskalatsioon](#eskalatsioon)
    - [Eeskirjad ja juhendid](#eeskirjad-ja-juhendid)
    - [Häirete testimine](#häirete-testimine)
    - [Häirete deduplikatsioon](#häirete-deduplikatsioon)
    - [Häirete ajakava](#häirete-ajakava)
  - [Teavituskanalid](#teavituskanalid)
    - [E-post](#e-post)
    - [Telegram](#telegram)
    - [Teised sõnumirakendused](#teised-sõnumirakendused)
    - [SMS (saatmine läbi lüüsi)](#sms-saatmine-läbi-lüüsi)
    - [SMS (saatmine läbi GSM-modemi)](#sms-saatmine-läbi-gsm-modemi)
    - [Push-teavitused](#push-teavitused)
    - [Piletid teenindustoes](#piletid-teenindustoes)
    - [Kõne sõnumiga](#kõne-sõnumiga)
  - [Häirete seadistamine Zabbix'is](#häirete-seadistamine-zabbixis)
    - [Teavituste loogika](#teavituste-loogika)
    - [Lahendatud probleemi käsitlemine](#lahendatud-probleemi-käsitlemine)
    - [Teavituste silumine](#teavituste-silumine)
  - [Portaalide ja andmebaaside monitoorimine](#portaalide-ja-andmebaaside-monitoorimine)
  - [Teemad](#teemad-2)
  - [Veebiserverite monitoorimine](#veebiserverite-monitoorimine)
  - [Veebportaali monitoorimise mõõdikud (1)](#veebportaali-monitoorimise-mõõdikud-1)
  - [Veebportaali monitoorimise mõõdikud (2)](#veebportaali-monitoorimise-mõõdikud-2)
  - [Veebportaali monitoorimise mõõdikud (3)](#veebportaali-monitoorimise-mõõdikud-3)
  - [Veebportaali monitoorimise mõõdikud (4)](#veebportaali-monitoorimise-mõõdikud-4)
  - [Näide: Apache monitoorimine (1)](#näide-apache-monitoorimine-1)
  - [Näide: Apache monitoorimine (2)](#näide-apache-monitoorimine-2)
  - [Näide: Apache monitoorimine (3)](#näide-apache-monitoorimine-3)
  - [Zabbix-agendi seadistamine](#zabbix-agendi-seadistamine)
  - [Näide: töölaud (dashboard)](#näide-töölaud-dashboard)
  - [Andmebaaside monitoorimine](#andmebaaside-monitoorimine)
  - [ODBC (Open Database Connectivity) monitoorimine. Zabbix sisseehitatud moodul](#odbc-open-database-connectivity-monitoorimine-zabbix-sisseehitatud-moodul)
  - [Zabbix agent UserParameter abil](#zabbix-agent-userparameter-abil)
  - [Moodulid Zabbix Agendi jaoks (libzbxpgsql, libzbxredis, zabbix-modulemysql jne)](#moodulid-zabbix-agendi-jaoks-libzbxpgsql-libzbxredis-zabbix-modulemysql-jne)
  - [Välised agendid (mamonsu, DBforBIX, ZabbixDBA, zbxdb, zbxora jne)](#välised-agendid-mamonsu-dbforbix-zabbixdba-zbxdb-zbxora-jne)
  - [Zabbix Agent 2](#zabbix-agent-2)
  - [](#-5)
  - [Zabbix Agent DBMON](#zabbix-agent-dbmon)
  - [Näide: MySQL monitoorimine (1)](#näide-mysql-monitoorimine-1)
  - [Näide: MySQL monitoorimine (2)](#näide-mysql-monitoorimine-2)
  - [Discovery trapper](#discovery-trapper)
  - [Teemad](#teemad-3)
  - [SNMP protokoll](#snmp-protokoll)
  - [SNMP: käskude näited](#snmp-käskude-näited)
  - [SNMP: haldurilt agendile](#snmp-haldurilt-agendile)
  - [Haldurilt agendile](#haldurilt-agendile)
  - [Agendilt haldurile](#agendilt-haldurile)
  - [MIB mõisted](#mib-mõisted)
  - [SNMP ja Zabbix](#snmp-ja-zabbix)
  - [Discovery](#discovery)
  - [Hostide avastamine](#hostide-avastamine)
  - [Näide](#näide)
  - [Hostide avastamine SNMP kaudu](#hostide-avastamine-snmp-kaudu)
  - [Näide](#näide-1)
  - [LLD: madala taseme avastamine](#lld-madala-taseme-avastamine)
  - [LLD: komponendid](#lld-komponendid)
  - [LLD: interaktsiooniskeem](#lld-interaktsiooniskeem)
  - [Prototüüpide loomine](#prototüüpide-loomine)
  - [Näide](#näide-2)
  - [Zabbix-sender](#zabbix-sender)
  - [Näide: Zabbix Discovery Trapper JSON Data Processing](#näide-zabbix-discovery-trapper-json-data-processing)
  - [Näide: Zabbix High Availability Data Flow](#näide-zabbix-high-availability-data-flow)
  - [Näide: Zabbix Enterprise Network Communication Paths](#näide-zabbix-enterprise-network-communication-paths)
  - [Näide: Enterprise Zabbix Architecture with High Availability](#näide-enterprise-zabbix-architecture-with-high-availability)
