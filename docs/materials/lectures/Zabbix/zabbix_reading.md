# Zabbix - Algaja teejuht

- [Zabbix - Algaja teejuht](#zabbix---algaja-teejuht)
  - [Mis on Zabbix?](#mis-on-zabbix)
  - [Miks me vajame jälgimist?](#miks-me-vajame-jälgimist)
  - [Zabbix'i põhikontseptsioonid](#zabbixi-põhikontseptsioonid)
  - [Zabbix'i tööpõhimõte](#zabbixi-tööpõhimõte)
  - [Jälgimise tüübid Zabbix'is](#jälgimise-tüübid-zabbixis)
  - [Zabbix'i kasutamise eelised](#zabbixi-kasutamise-eelised)
  - [Praktiline näide: Serveri jälgimine](#praktiline-näide-serveri-jälgimine)
- [Zabbix'i implementeerimine](#zabbixi-implementeerimine)
  - [Peamised valikud implementeerimisel](#peamised-valikud-implementeerimisel)
  - [Praktiline lähenemine juurutamisele](#praktiline-lähenemine-juurutamisele)
    - [1. Pilootfaas](#1-pilootfaas)
    - [2. Laiendamine ja kohandamine](#2-laiendamine-ja-kohandamine)
    - [3. Automatiseerimine ja optimeerimine](#3-automatiseerimine-ja-optimeerimine)
  - [Eduka juurutuse võtmetegurid](#eduka-juurutuse-võtmetegurid)
  - [Zabbix'i struktuur](#zabbixi-struktuur)
    - [Arhitektuuri komponendid](#arhitektuuri-komponendid)
    - [Andmevoogude hierarhia](#andmevoogude-hierarhia)
    - [Zabbix'i komponentide rollid ja vastastikused seosed](#zabbixi-komponentide-rollid-ja-vastastikused-seosed)
    - [Andmete liikumine süsteemis](#andmete-liikumine-süsteemis)
    - [Zabbix 7.0.2 versioon](#zabbix-702-versioon)
- [Building a Monitoring Dashboard: Which Metrics to Track?](#building-a-monitoring-dashboard-which-metrics-to-track)
  - [Olulised jälgimismeetrikad](#olulised-jälgimismeetrikad)
  - [Tõhusa jälgimislaua loomise põhimõtted](#tõhusa-jälgimislaua-loomise-põhimõtted)
- [Zabbix'i olulised asjad](#zabbixi-olulised-asjad)
  - [Andmete kogumise meetodid](#andmete-kogumise-meetodid)
    - [Agendiga jälgimine](#agendiga-jälgimine)
    - [Agendita jälgimine](#agendita-jälgimine)
    - [API ja välised skriptid](#api-ja-välised-skriptid)
  - [Templates ja mallide kasutamine](#templates-ja-mallide-kasutamine)
    - [Mallide struktuur](#mallide-struktuur)
    - [Mallide haldamine](#mallide-haldamine)
    - [Levinud mallid](#levinud-mallid)
  - [Häiremine ja teavitused](#häiremine-ja-teavitused)
    - [Triggerite loomine](#triggerite-loomine)
    - [Teavituste seadistamine](#teavituste-seadistamine)
    - [Tegevuste seadistamine (Actions)](#tegevuste-seadistamine-actions)
  - [Automaatne avastamine ja registreerimine](#automaatne-avastamine-ja-registreerimine)
    - [Network Discovery](#network-discovery)
    - [Auto-registration](#auto-registration)
    - [Low-Level Discovery (LLD)](#low-level-discovery-lld)
  - [Andmete salvestamine ja haldamine](#andmete-salvestamine-ja-haldamine)
    - [Andmete elutsükkel](#andmete-elutsükkel)
    - [Andmebaasi hooldus](#andmebaasi-hooldus)
    - [Varundamine](#varundamine)
  - [Optimeerimise vajaduse märgid](#optimeerimise-vajaduse-märgid)
  - [Optimeerimise samm-sammult](#optimeerimise-samm-sammult)
  - [API kasutamine](#api-kasutamine)
    - [API põhitoimingud](#api-põhitoimingud)
    - [Automatiseerimine](#automatiseerimine)
    - [Levinud API kasustusjuhud](#levinud-api-kasustusjuhud)
  - [Tõrkeotsing ja logide analüüs](#tõrkeotsing-ja-logide-analüüs)
    - [Logifailid](#logifailid)
    - [Levinud probleemid](#levinud-probleemid)
    - [Diagnostika tööriistad](#diagnostika-tööriistad)
  - [Zabbix'i integreerimine teiste süsteemidega](#zabbixi-integreerimine-teiste-süsteemidega)
    - [Teavitussüsteemid](#teavitussüsteemid)
    - [Monitooringusüsteemid](#monitooringusüsteemid)
    - [IT-haldussüsteemid](#it-haldussüsteemid)
